...
namespace MySql.Debugger.Tests
{
  ...
  {
    public static readonly string CONNECTION_STRING = "server=localhost;User Id=root;database=test6;Allow User Variables=true;Pooling=false;Allow Zero DateTime=true;";
